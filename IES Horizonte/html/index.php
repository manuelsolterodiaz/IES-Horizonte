    ...
    <div class="row g-4">
      <div class="col-md-6 col-lg-3">
        <div class="card card-option shadow">
          <img src="https://cdn-icons-png.flaticon.com/512/3135/3135755.png" class="card-img-top" alt="Alumnos">
      ...
      <div class="col-md-6 col-lg-3">
        <div class="card card-option shadow">
          <img src="https://cdn-icons-png.flaticon.com/512/2917/2917995.png" class="card-img-top" alt="Notas">
          <div class="card-body text-center">
      ...
      <div class="col-md-6 col-lg-3">
        <div class="card card-option shadow">
          <img src="https://cdn-icons-png.flaticon.com/512/1828/1828911.png" class="card-img-top" alt="Ver notas">
          <div class="card-body text-center">
      ...
      <div class="col-md-6 col-lg-3">
        <div class="card card-option shadow">
          <img src="https://cdn-icons-png.flaticon.com/512/1828/1828479.png" class="card-img-top" alt="Cerrar sesión">
          <div class="card-body text-center">
